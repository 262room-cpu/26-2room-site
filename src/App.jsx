  ...
  const ecosystem = [
    {
      icon: 'APP',
      title: 'App',
      text: 'Приложение для поиска стартов, избранного, фильтров, карты и планирования сезона.',
    },
    {
      icon: 'SITE',
      title: 'Site',
      ...
      <main>
        ...
        <section className="whySection">
          <div className="whyIntro">
            ...
            <p>
              ...
              комьюнити, приложение и партнёрские интеграции в одну
              экосистему.
            </p>
          </div>
        ...
        <section className="platformSection">
          <div className="platformIntro">
            ...
            <p>
              Полный календарь, фильтры, карта, избранное и другие возможности
              доступны в приложении 26.2 ROOM.
            </p>
          </div>
